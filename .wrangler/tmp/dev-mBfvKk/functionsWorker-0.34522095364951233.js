...
// .wrangler/tmp/pages-QfTpEd/functionsWorker-0.34522095364951233.mjs
...
async function onRequest(context2) {
  ...
  if (accept.includes("text/markdown")) {
    ...
    let mdResponse = await env2.ASSETS.fetch(mdRequest);
    if (!mdResponse.ok && !mdPath.endsWith("index.md")) {
      const fallbackUrl = new URL(url.pathname.replace(/\/?$/, "/index.md"), request.url);
      mdResponse = await env2.ASSETS.fetch(new Request(fallbackUrl, request));
    }
    if (mdResponse.ok) {
...
// .wrangler/tmp/bundle-bfzbiY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bfzbiY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.34522095364951233.js.map
